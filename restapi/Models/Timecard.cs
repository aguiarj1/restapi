...
namespace restapi.Models
{
    public class Timecard
    {
        ...
        public bool containsLine(String lineid)
        {
            bool answer = false; 
            float lineidF = float.Parse(lineid, System.Globalization.CultureInfo.InvariantCulture);
            for (int i=0; i<Lines.Count(); i++)
            {
                if(Lines.ElementAt(i).LineNumber == lineidF)
                {
                    answer = true; 
                }
            }
        ...
        public void updateLine(String lineid, TimecardLine timecardLine)
        {
